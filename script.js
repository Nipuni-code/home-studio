...
mSwitch.addEventListener('click', () => {
  ...
  // === home buttons ====
  function spotify() {
    window.open('https://open.spotify.com/artist/1PIwJmaGQdMryTvdYUSpGj?si=lUtymQ6KRvq_kKL_DqQaNw', '_blank'); // open the twitter page on a new window 
  }  
  function youtube() {
    window.open('https://www.youtube.com/@hOmEstudio1231', '_blank'); // open the twitter page on a new window 
  };
